...
<table id="view-student-grades" class="table table-responsive table-bordered table-hover table-condensed">
															...
															<tr>
																...
																<td><a id="${studentGrade.id}" class="updateBtn" style="text-decoration:none; color:white; background-color:#3366FF; padding:7px; border-radius: 28px;" role="button" >Update</a></td>
																<td><a href="#" id="${studentGrade.id}"  class="deleteBtn" style="text-decoration:none; color:white; background-color:#3366FF; padding:7px; border-radius: 28px;" role="button">Delete</a></td>
															</tr>
														</c:forEach>
													</tbody>
														</table>