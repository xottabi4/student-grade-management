				...
				<meta name="viewport" content="width=device-width, initial-scale=1">
					<meta name="description" content="">
						<meta name="author" content="">
							<title>SGM professor update group</title>
							...
							<link href="<c:url value=" /resources/css/pageLayout.css" />" rel="stylesheet">
								...
								<link rel="stylesheet" href="/webjars/bootstrap/3.3.6/css/bootstrap.min.css">
									<link rel="stylesheet" href="/webjars/bootstrap/3.3.6/css/bootstrap-theme.min.css">
										...
										<script src="<c:url value=" /resources/js/professor/updateGroup.js" />"></script>
									</head>
														...
														<hr>
															<div class="row">
																...
																<div class="col-sm-6 center-block">
																	<a href="#" id="submit-data" class="btn btn-primary btn-lg pull-right " role="button">Update</a>
																</div>
